              ...
              <div class="wizard-basic-step">
                <b-form class="av-tooltip tooltip-label-right">
                  <b-form-group :label="$t('forms.name')">
                    <b-form-input
                      type="text"
                      v-model.trim="$v.formStep1.name.$model"
                      :state="!$v.formStep1.name.$error"
                    />
              ...
              <div class="wizard-basic-step">
                <b-form class="av-tooltip tooltip-label-right">
                  <b-form-group :label="$t('forms.email')">
                    <b-form-input
                      type="text"
                      v-model="$v.formStep2.email.$model"
                      :state="!$v.formStep2.email.$error"
                    />
                    <b-form-invalid-feedback v-if="!$v.formStep2.email.required"
                      >Please enter your email address</b-form-invalid-feedback
                    >
                    <b-form-invalid-feedback v-else-if="!$v.formStep2.email.email"
              ...
              <div class="wizard-basic-step">
                <b-form class="av-tooltip tooltip-label-right">
                  <b-form-group :label="$t('forms.password')">
                    <b-form-input
                      type="password"
                      v-model.trim="$v.formStep3.password.$model"
                      :state="!$v.formStep3.password.$error"
                    />
        ...
        <tab type="done">
          <div class="wizard-basic-step text-center pt-3">
            <div v-if="isProcessing">
              ...
              <p>{{ $t("Your new intent is being added...") }}</p>
            </div>
            <div v-else>
              <h2 class="mb-2">{{ $t("wizard.content-thanks") }}</h2>
              <p>{{ $t("Intent is Added Successfully!") }}</p>
            </div>
          </div>
        </tab>
      </form-wizard>
